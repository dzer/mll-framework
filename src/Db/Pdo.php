...
class Pdo
{
    ...
    public function __construct($config = null, $className = null, $dbName = null)
    {
        ...
        $this->config = $config;
        if (empty($this->config['ping_time'])) {
            $this->config['ping_time'] = 3600;
        }
        if (!empty($className)) {
        ...
        $this->lastTime = time() + $this->config['ping_time'];
        $this->checkPing();
    }
    ...
    public function ping()
    {
        ...
        $this->lastTime = $now + $this->config['ping_time'];
